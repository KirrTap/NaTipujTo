      ...
      <div style={{ textAlign: 'center', marginTop: '32px' }}>
        <div style={{
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 260 }}>
            <thead>
              <tr>
                <th style={{ padding: '8px', borderBottom: '2px solid #1976d2', fontWeight: 600, background: '#e3f2fd', borderRadius: '8px 8px 0 0' }}>Meno</th>
                <th style={{ padding: '8px', borderBottom: '2px solid #1976d2', fontWeight: 600, background: '#e3f2fd', borderRadius: '8px 8px 0 0' }}>Body</th>
              </tr>
            </thead>
            <tbody>
              {ranking.map((row) => (
                <tr key={row.username} style={{ background: 'white', fontWeight: 500 }}>
                  <td style={{ padding: '8px', borderBottom: '1px solid #eee' }}>{row.username}</td>
